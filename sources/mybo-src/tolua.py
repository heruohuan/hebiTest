...
def main():
    ...
    cocos_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', 'xquick'))
    ...
    try:
        ...
        tolua_root = '%s' % project_root
        output_dir = '%s/lua-bindings' % project_root

        cmd_args = {'mybo_extensions.ini' : ('mybo_extensions', 'lua_mybo_extensions_auto'), \
                    }
        target = 'lua'
